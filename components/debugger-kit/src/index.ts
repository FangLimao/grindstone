...
export class LoggerManager {
   ...
   */
  static getLogger(id: string, feedback?: string): LoggerManager {
    return new LoggerManager(id, feedback);
  }
  /**
   ...
   */
  warn(message: string, players?: Player[]): void {
   ...
   * @param players the players that would receive stack trace.
   */
  error(message: string, players?: Player[]): void {
